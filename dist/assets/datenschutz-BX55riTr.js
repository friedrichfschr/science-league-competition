import{a as e,i as t,r as n,t as r}from"./shared-Btn7WAdQ.js";var i=document.querySelector(`#app`);i.innerHTML=t({activePage:null,hero:n({eyebrow:`Rechtliches`,title:`Datenschutzerklärung`}),content:`
  <section class="px-5 pb-16 lg:px-6 lg:pb-24" aria-labelledby="datenschutz-heading">
    <div class="mx-auto max-w-3xl space-y-5">
      ...
      ${[{title:`Verantwortliche Stelle`,body:`
    ...
    `},{title:`Welche Daten wir verarbeiten`,body:`
    ...
    `},{title:`Keine Weitergabe an Dritte`,body:`
    ...
    `}].map((e,t)=>`
        <div class="reveal rounded-[1.5rem] border border-stone-200 bg-white/85 p-7 shadow-[var(--shadow-sm)] sm:p-9">
          <h2 class="font-display text-xl font-semibold text-stone-950">${e.title}</h2>
