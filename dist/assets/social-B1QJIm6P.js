import{d as e,i as t,r as n,t as r}from"./shared-CxqreL70.js";var i=document.querySelector(`#app`);i.innerHTML=t({activePage:`social`,hero:n({eyebrow:`Soziales & Community`,title:`Der Markt funktioniert auch als Treffpunkt, Lernort und Raum für Beteiligung.`,intro:`Soziale Angebote stehen hier nicht am Rand. Sie sind als eigene Seite organisiert, damit Menschen schnell erkennen, welche Formate der FoodConnectMarkt neben dem Einkauf anbietet.`,actions:[{href:`food.html`,label:`Food ansehen`},{href:`index.html`,label:`Zurück zu Über uns`}],supportingCard:`
  ...
  <section class="px-5 py-8 lg:px-6 lg:py-12">
    <div class="mx-auto grid max-w-7xl gap-10 xl:grid-cols-[0.82fr_1.18fr] xl:items-start">
      <div>
        ...
        <div class="mt-8 border-l-4 border-amber-700 bg-amber-50 px-6 py-6">
  ...
  <section class="px-5 py-8 lg:px-6 lg:py-12">
    <div class="mx-auto max-w-7xl border-y border-stone-300">
      <a href="index.html" class="grid gap-3 border-b border-stone-200 py-6 transition hover:bg-white/60 md:grid-cols-[12rem_1fr_auto] md:items-center md:gap-6">
        <p class="text-xs font-semibold uppercase tracking-[0.28em] text-emerald-800">Über uns</p>
        <div>
          <h3 class="text-2xl font-semibold text-stone-950">Projekt, Mission und Science-League-Kontext</h3>
          <p class="mt-2 text-sm leading-7 text-stone-600">Zur strukturierten Startseite mit Teamstory und Projektlogik.</p>
        </div>
      ...
      <a href="food.html" class="grid gap-3 py-6 transition hover:bg-white/60 md:grid-cols-[12rem_1fr_auto] md:items-center md:gap-6">
        ...
        <div>
          <h3 class="text-2xl font-semibold text-stone-950">Produktsuche und Warenkorb</h3>
          <p class="mt-2 text-sm leading-7 text-stone-600">Zum Shop-Bereich mit Filtern, starken Karten und klaren CTAs.</p>
        </div>
        <span class="text-sm font-medium text-stone-500">Öffnen →</span>
      </a>
    </div>
