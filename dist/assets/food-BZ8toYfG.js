                    ...
                    <article class="rounded-[1.35rem] border border-white/10 bg-white/5 px-4 py-4">
                      ...
                      <div class="mt-4 flex items-center justify-between gap-3">
                        <div class="inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/5 px-2 py-2">
                          ...
                          <button type="button" data-action="increase" data-id="${e.id}" class="grid h-8 w-8 place-items-center rounded-full bg-emerald-500 text-lg text-white transition hover:bg-emerald-400">+</button>
                        </div>
