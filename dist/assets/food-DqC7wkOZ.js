...
Generiert auf FoodConnectMarkt`),a=`mailto:${t?.email?encodeURIComponent(t.email):``}?subject=Meine%20Einkaufsliste%20%E2%80%93%20FoodConnectMarkt&body=${i}`;return`
    ...
    </div>`}function H(){let t=D();S(),g.innerHTML=n({activePage:`food`,hero:i({eyebrow:`Der Gemüseturm`,title:`Produkte aus unserem Vertical Farming.`,intro:`Knackig, frisch und lokal produziert. Filtere nach Kategorie oder Bestand, lege Produkte in den Korb und sieh den Einkauf live wachsen.`}),content:`
